...
[cols="<,<,<,<",options="header",]
|=======================================================================
|Setting |Input type|Required|Note
| <<plugins-{type}s-{plugin}-project_id>> |<<string,string>>|Yes|
| <<plugins-{type}s-{plugin}-topic>> |<<string,string>>|Yes|
| <<plugins-{type}s-{plugin}-cloud_zone>> |<<string,string>>|Yes|Only PubSubLite
...
[id="plugins-{type}s-{plugin}-cloud_zone"]
===== `cloud_zone`

  * Value type is <<string,string>>
  * There is no default value for this setting.
  * ex. "asia-northeast1-b"

Google Cloud Pub/Sub Lite Cloud Zone. ( Only Pub/Sub Lite)
